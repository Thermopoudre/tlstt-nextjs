...
export default function ProgressionsPage() {
  ...
  const [ffttStatus, setFfttStatus] = useState<string>('')
  ...
  const filteredPlayers = tous
    ...
    .slice(0, searchQuery ? 50 : 30)

  // Top 3 pour les podiums
  const podiumMois = topMois.slice(0, 3)
  const podiumSaison = topSaison.slice(0, 3)

  // Vérifier si on a des progressions réelles
  const hasRealProgressions = tous.some(p => p.progressionMois !== 0 || p.progressionSaison !== 0)
    ...
    return (
      <div className="min-h-screen bg-[#0f3057] flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-white/60">Chargement des progressions...</p>
          <p className="text-white/40 text-sm mt-2">Connexion à l'API FFTT...</p>
        </div>
      </div>
    )
  }
  ...
  return (
    <div className="min-h-screen bg-[#0f3057]">
      ...
      <div className="py-12 bg-[#0f3057]">
        <div className="container-custom text-center">
          <div className={`inline-flex items-center gap-2 px-4 py-2 rounded-full text-sm font-semibold mb-4 ${
            ...
            <i className={`fas ${source === 'FFTT Live' ? 'fa-check-circle' : 'fa-exclamation-circle'}`}></i>
            {source === 'FFTT Live' ? 'Données FFTT en direct' : 'Données locales (FFTT indisponible)'}
          </div>
          ...
          {ffttStatus && ffttStatus.includes('Indisponible') && (
            <div className="mt-4 bg-yellow-500/10 border border-yellow-500/30 rounded-lg p-4 max-w-xl mx-auto">
      ...
      <div className="container-custom pb-12 -mt-8">
        ...
        {/* Podiums Section - Affichés seulement si progressions réelles */}
        {hasRealProgressions && (
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-12">
            ...
            <div className="bg-white/5 border border-white/10 rounded-3xl p-8">
              ...
              <div className="flex items-end justify-center gap-4 h-64">
                {/* 2e place */}
                {podiumMois[1] && podiumMois[1].progressionMois > 0 && (
                ...
                {/* 1er place */}
                {podiumMois[0] && podiumMois[0].progressionMois > 0 && (
                ...
                {/* 3e place */}
                {podiumMois[2] && podiumMois[2].progressionMois > 0 && (
                  <div className="flex flex-col items-center">
              ...
              {!podiumMois.some(p => p.progressionMois > 0) && (
            ...
            <div className="bg-white/5 border border-white/10 rounded-3xl p-8">
              ...
              <div className="flex items-end justify-center gap-4 h-64">
                {/* 2e place */}
                {podiumSaison[1] && podiumSaison[1].progressionSaison > 0 && (
                  <div className="flex flex-col items-center">
                ...
                {/* 1er place */}
                {podiumSaison[0] && podiumSaison[0].progressionSaison > 0 && (
                  <div className="flex flex-col items-center -mt-8">
                    <div className="relative">
                      <i className="fas fa-crown text-yellow-400 text-2xl absolute -top-8 left-1/2 -translate-x-1/2 animate-bounce"></i>
                ...
                {/* 3e place */}
                {podiumSaison[2] && podiumSaison[2].progressionSaison > 0 && (
                  <div className="flex flex-col items-center">
              ...
              {!podiumSaison.some(p => p.progressionSaison > 0) && (
                <div className="text-center text-white/40 py-8">
                  <i className="fas fa-info-circle mr-2"></i>
                  Aucune progression cette saison
                </div>
              )}
            </div>
          </div>
        ...
        {stats?.recordMois && stats.recordMois.progressionMois > 0 && (
        ...
        <div className="bg-white/5 border border-white/10 rounded-2xl overflow-hidden">
          <div className="p-6 border-b border-white/10">
            <h3 className="text-xl font-bold text-white">
              ...
              {hasRealProgressions ? 'Classement des Progressions' : 'Classement par Points'}
              <span className="text-white/40 text-sm font-normal ml-2">
                ({searchQuery ? `${filteredPlayers.length} résultats` : 'Top 30'})
              </span>
            </h3>
          </div>
                  ...
                  {hasRealProgressions && (
                    <>
                      <th className="px-6 py-4 text-right text-sm font-semibold text-white/70">
                        {filterPeriode === 'mois' ? 'Prog. Mois' : 'Prog. Saison'}
                      </th>
