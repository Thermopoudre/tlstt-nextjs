      ...
      <div className="bg-[#0f3057] py-16">
        <div className="container-custom">
          <h1 className="text-4xl md:text-5xl font-bold text-white mb-4">
            <i className="fas fa-images mr-3 text-[#5bc0de]"></i>
            Galerie Photo
          </h1>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
          <div className="card text-center border-l-4 border-[#5bc0de]">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-3xl font-bold text-[#0f3057]">{albums?.length || 0}</p>
              </div>
              <div className="w-12 h-12 bg-[#e8f4f8] rounded-lg flex items-center justify-center">
                <i className="fas fa-folder text-2xl text-[#5bc0de]"></i>
              </div>
            </div>
          </div>
          ...
          <div className="card text-center border-l-4 border-[#5bc0de]">
            <div className="flex items-center justify-between">
              ...
              <div className="w-12 h-12 bg-[#e8f4f8] rounded-lg flex items-center justify-center">
                <i className="fas fa-camera text-2xl text-[#5bc0de]"></i>
              </div>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {albumsWithCovers.map((album) => (
              <Link
                ...
                className="group"
              >
                <div className="card overflow-hidden hover:shadow-2xl transition-all duration-300 hover:scale-105 hover:border-[#5bc0de]">
                  {/* Image de couverture */}
                  <div className="relative h-64 bg-[#e8f4f8] overflow-hidden">
                    {album.coverPhoto ? (
                      <Image
                      ...
                      <div className="w-full h-full flex items-center justify-center bg-[#0f3057]">
                        <i className="fas fa-images text-6xl text-[#5bc0de] opacity-50"></i>
                      </div>
                    )}
                    
                    {/* Badge nombre de photos */}
                    <div className="absolute top-4 right-4 bg-white/90 rounded-full px-3 py-1 flex items-center gap-2 shadow-lg">
                      <i className="fas fa-camera text-[#5bc0de]"></i>
                      <span className="font-bold text-gray-800">{album.photoCount}</span>
                    </div>

                    {/* Badge type d'événement */}
                    {album.event_type && (
                      <div className="absolute bottom-4 left-4 bg-[#5bc0de]/90 rounded-full px-3 py-1 text-white font-semibold text-sm">
                        {album.event_type}
                      </div>
                    )}
                  </div>
                  ...
                  <div className="p-5">
                    ...
                    <div className="flex items-center justify-between text-sm text-gray-500">
                      ...
                      <span className="text-[#5bc0de] font-semibold flex items-center gap-1">
                        Voir l'album
