...
export default function AdminCommandesPage() {
  ...
  const getStatusBadge = (status: string) => {
    switch (status) {
      ...
      case 'processing':
        return <span className="px-2 py-1 bg-blue-100 text-blue-800 rounded-full text-xs font-medium">En cours</span>
      case 'completed':
        return <span className="px-2 py-1 bg-green-100 text-green-800 rounded-full text-xs font-medium">Terminée</span>
      case 'cancelled':
