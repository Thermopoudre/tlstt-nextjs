      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div className="bg-white rounded-xl shadow-lg p-6">
          ...
          <div className="space-y-4">
            ...
            <div>
              <label className="block text-sm font-medium text-gray-700 mb-1">Histoire du club</label>
              <textarea
                value={settings.history}
                onChange={(e) => setSettings({...settings, history: e.target.value})}
                rows={5}
                className="input-field"
                placeholder="Racontez l'histoire de votre club..."
              />
            </div>
          </div>
        </div>
          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              <input
                ...
                onChange={(e) => setSettings({...settings, treasurer: e.target.value})}
                className="input-field"
